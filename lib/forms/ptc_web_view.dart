...
class PTCWebView extends StatefulWidget {
  static String id = "PTCWebView";

  @override
  State<PTCWebView> createState() => _PTCWebViewState();
}

class _PTCWebViewState extends State<PTCWebView> {
  @override
